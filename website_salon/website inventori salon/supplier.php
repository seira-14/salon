...
if (isset($_GET['hapus'])) {
    ...
    $query_hapus = "DELETE FROM supplier WHERE id_supplier = ?";
    ...
    if ($stmt_hapus->execute()) {
        ...
        $_SESSION['error_message'] = "Gagal menghapus data supplier. Mungkin supplier masih digunakan oleh barang.";
    }
...
<head>
    ...
    <title>Data Supplier - Sistem Inventori Salon</title>
        ...
        <div class="main-wrapper">
            <main class="content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="supplier_tambah.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
                                                    <div class='btn-group'>
                                                        <a href='supplier_edit.php?id=" . $row['id_supplier'] . "' class='btn btn-sm btn-warning'>
                                                            <i class='bi bi-pencil'></i>
                                                        </a>
                                                        <a href='supplier.php?hapus=" . $row['id_supplier'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Yakin ingin menghapus supplier ini?\")'>
